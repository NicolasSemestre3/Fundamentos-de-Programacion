...
namespace Coordenadas
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                //pedimos los puntos
                Console.WriteLine("\n\nCapitan dame las coordenadas de el lugar No" + (contador + 1) + " en X");
                coordenadaX[contador] = double.Parse(Console.ReadLine());

                //pedimos los puntos
                Console.WriteLine("\nCapitan dame las coordenadas de el lugar No" + (contador + 1) + " en Y");
            ...
            for (int contadorRecta = 0; contadorRecta < 2; contadorRecta++)
            {
                ...
                {
                    Console.WriteLine("\n\nEl punto (" + coordenadaX[contadorRecta] + " , " + coordenadaY[contadorRecta] + ") y el punto (" + coordenadaX[contadorRecta + 1] + " , " + coordenadaY[contadorRecta + 1] + ") Estan en la misma recta");
                }
                else
                {
                    Console.WriteLine("\n\nEl punto (" + coordenadaX[contadorRecta] + " , " + coordenadaY[contadorRecta] + ") y el punto (" + coordenadaX[contadorRecta + 1] + " , " + coordenadaY[contadorRecta + 1] + ") Estan en una diferente recta");
                }
            }
            ...
            Console.WriteLine("\n\nLa mayor distancia fue : " + mayorDistancia);
            Console.WriteLine("Entre el punto (" + puntoInicialX + " , " + puntoInicialY + ") y el punto (" + puntoFinalX + " , " + puntoFinalY + " )" );
