...
namespace Reto_Imposible_Parte_1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nHoy es la leccion numero 1, el primer acto de esté martirio");
            Console.WriteLine("\nIniciando programa...");
            Console.WriteLine("\n...");
            Console.WriteLine("\n...");
            Console.WriteLine("\n...");
            ...
            Console.WriteLine("\n\nLa primera secion es sobre la union de conjuntos asi que para iniciar...");
            Console.WriteLine("\nVamos a unir dos conjuntos capitan, por que eso si puedo unir lo que no puedo unir es tu corazon con otro");
